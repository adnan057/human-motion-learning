...
def loadDataset():
    patches = pickle.load(open('data/patches_100000.p','rb'))
	
    return normalizeDataset(patches)
...
def executeSparseAutoencoder():
    ...
    vis_patch_side = 15      # side length of sampled image patches
    ...
    opt_solution  = scipy.optimize.minimize(encoder.sparseAutoencoderCost, encoder.theta, args = (training_data,), method = 'L-BFGS-B', 
