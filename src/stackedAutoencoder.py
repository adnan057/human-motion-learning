...
def executeStackedAutoencoder():
    ...
    visible_size   = 144*180    # size of input vector
    ...
    train_data    = loadData('data/train_data.p')
    train_labels  = loadLabels('data/train_labels.p')

    print(train_data.shape)
    print(train_labels.shape)
 
    print('optimizing encoder 1...')
    ...
    test_data    = loadData('data/test_data.p')
    test_labels  = loadLabels('data/test_labels.p')
    ...
    print(test_labels[:, 0])
    print(predictions[:, 0])
    print ("""\nAccuracy after greedy training :""", numpy.mean(correct))
